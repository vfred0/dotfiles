...
static const Rule rules[] = {
    ...
    { "qBittorrent", NULL, NULL,  1 << 4, 1, 1, -1 },
    { "Spotify", NULL, NULL,  1 << 4, 1, 0, -1 },
    { "Nsxiv", NULL, NULL,  0, 1, 1, -1 },
    { "Nsxiv", NULL, NULL,  0, 1, 1, -1 },
    { "jetbrains-webstorm", NULL, NULL,  1 << 1, 1, 0, -1 },
    { "jetbrains-idea", NULL, NULL,  1 << 2, 1, 0, -1 },
...
static const Key keys[] = {
    ...
    // {0, XF86XK_AudioMedia, spawn, SHCMD("rofi-playerctl")},
    {MODKEY | ShiftMask , XK_Escape, spawn, SHCMD("rofi-playerctl")},
    ...
    {MODKEY,                            XK_Escape,       spawn,          SHCMD("start-picom")},
